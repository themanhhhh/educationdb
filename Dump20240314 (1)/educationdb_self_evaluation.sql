...
CREATE TABLE `self_evaluation` (
  ...
  CONSTRAINT `self_evaluation_ibfk_1` FOREIGN KEY (`EvaluationID`) REFERENCES `evaluation` (`EvaluationID`),
  CONSTRAINT `self_evaluation_ibfk_2` FOREIGN KEY (`StudentID`) REFERENCES `students` (`StudentID`)
