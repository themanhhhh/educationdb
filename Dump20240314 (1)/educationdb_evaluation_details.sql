...
CREATE TABLE `evaluation_details` (
  ...
  CONSTRAINT `evaluation_details_ibfk_1` FOREIGN KEY (`EvaluationID`) REFERENCES `evaluation` (`EvaluationID`),
  CONSTRAINT `evaluation_details_ibfk_2` FOREIGN KEY (`CriteriaID`) REFERENCES `evaluation_criteria` (`CriteriaID`)
...
-- Dump completed on 2024-03-14 14:04:52
