...
CREATE TABLE `student_homework` (
  ...
  `CompletionStatus` enum('Completed','Not Completed') DEFAULT NULL,
  KEY `StudentID` (`StudentID`),
  KEY `HomeworkID` (`HomeworkID`),
  CONSTRAINT `student_homework_ibfk_1` FOREIGN KEY (`StudentID`) REFERENCES `students` (`StudentID`),
  CONSTRAINT `student_homework_ibfk_2` FOREIGN KEY (`HomeworkID`) REFERENCES `homework` (`HomeworkID`)
